...
const skillsSection = {
  ...
  skills: [
    ...
    emoji(
      "⚡ Develop cross-platform mobile apps and Progressive Web Apps (PWAs) using Flutter, React Native, and web technologies",
    ),
    emoji(
  ...
  experience: [
    {
      ...
      descBullets: [
        ...
        "Developed an Inertial Profiler Progressive Web App (PWA) to parse large CSV files, automate mathematical engineering calculations, and generate real-time pass/fail validation reports.",
        "Modernized the Instron Bluehill Universal hardware telemetry pipeline from legacy C to C++ utilizing SOAP web services to automatically ingest machine test results into the DIME database.",
        "Managed release lifecycles, deploying and verifying code updates across Development, Staging, and Production environments while leading legacy migrations from PHP 5 to PHP 8.",
        ...
        "Developed a financial timesheet tool querying Deltek Vision’s Microsoft SQL Server database to extract and automate enterprise accounting reports.",
        "Contributed to both frontend and backend development while working in an Agile team environment.",
        "Provided 1+ year of internal IT desktop systems support and Office 365 administration, configuring user access and troubleshooting hardware/network issues.",
      ],
    },
    {
      ...
      desc: "",
      descBullets: [
        "Managed a multi-host VMware ESXi virtualized infrastructure, provisioning, configuring, and maintaining Windows and Linux virtual machines for enterprise network software validation.",
        "Deployed and managed virtualized private cloud lab environments using Mirantis Fuel OpenStack, configuring virtual compute, storage, and networking to simulate carrier-grade switch and router environments.",
        "Administered and maintained MySQL and Oracle database instances used for network management verification, database seeding, and performance benchmarking.",
        "Packaged and validated multi-platform software installers using InstallAnywhere, debugging installation scripts across varied OS platforms.",
        "Managed defect lifecycles and release tracking in JIRA, collaborating closely with developers, infrastructure teams, and customer support.",
        "Built automated regression and functional test suites using Selenium to safeguard software reliability prior to production releases.",
      ],
    },
  ],
};
